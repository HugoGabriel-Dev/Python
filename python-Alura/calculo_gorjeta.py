...
gorjeta_porcentagem = float(input('Digite o valor desejado para gorjeta: '))

def calcular_gorjeta(conta, gorjeta):
    valor_gorjeta = (conta / 100) * gorjeta
    return valor_gorjeta

print(f'O valor de gorjeta deve ser: {calcular_gorjeta(valor_conta, gorjeta_porcentagem)}') 
print(f'O valor com a gorjeta deve ser: {valor_conta + calcular_gorjeta(valor_conta, gorjeta_porcentagem)}')  